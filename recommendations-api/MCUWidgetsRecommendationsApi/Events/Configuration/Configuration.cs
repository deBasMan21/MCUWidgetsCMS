...
namespace Infrastructure.Configuration
{
	public static class Configuration
	{
        ...
        private static void DetermineUsername()
        {
            _userName = Environment.GetEnvironmentVariable("RABBITMQ_DEFAULT_USER");
        ...
        private static void DeterminePassword()
        {
            _password = Environment.GetEnvironmentVariable("RABBITMQ_DEFAULT_PASS");
