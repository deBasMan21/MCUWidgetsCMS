...
export interface ApiActorActor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::actor.actor'> &
      Schema.Attribute.Private;
    mcu_projects: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiChronologyChronology extends Struct.SingleTypeSchema {
...
export interface ApiCollectionCollection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    backdrop_url: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiMcuProjectMcuProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    AwardsNominated: Schema.Attribute.Integer;
    AwardsWon: Schema.Attribute.Integer;
    backdropUrl: Schema.Attribute.String;
    BoxOffice: Schema.Attribute.BigInteger &
    ...
    chronology: Schema.Attribute.Integer;
    ...
    directors: Schema.Attribute.Relation<
      ...
      'api::director.director'
    >;
    DisneyPlusUrl: Schema.Attribute.String;
    Duration: Schema.Attribute.Integer;
    episodes: Schema.Attribute.Component<'episode.episode', true>;
    ...
    >;
    notificationTopic: Schema.Attribute.String & Schema.Attribute.Unique;
    Overview: Schema.Attribute.RichText;
    Phase: Schema.Attribute.Enumeration<
      ['Phase 1', 'Phase 2', 'Phase 3', 'Phase 4', 'Phase 5', 'Phase 6']
    >;
    PostCreditScenes: Schema.Attribute.Integer;
    Posters: Schema.Attribute.Component<'poster.poster', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 10;
        ...
        number
      >;
    ProductionBudget: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    Quote: Schema.Attribute.String;
    QuoteCaption: Schema.Attribute.String;
    rankingChangeDirection: Schema.Attribute.Enumeration<
      ['UP', 'DOWN', 'FLAT']
    >;
    rankingCurrentRank: Schema.Attribute.Integer;
    rankingDifference: Schema.Attribute.Integer;
    ...
    ReleaseDateNameOverride: Schema.Attribute.String;
    ...
    Saga: Schema.Attribute.Enumeration<['Infinity Saga', 'Multiverse Saga']>;
    seasonNumber: Schema.Attribute.Integer;
    Seasons: Schema.Attribute.Component<'episode.season', true>;
    Source: Schema.Attribute.Enumeration<
      ['MCU', 'Fox', 'MarvelTelevision', 'MarvelOther', 'Sony', 'Defenders']
    > &
      Schema.Attribute.Required;
    spotifyEmbed: Schema.Attribute.Text;
    Title: Schema.Attribute.String & Schema.Attribute.Required;
    tmdb_id: Schema.Attribute.String & Schema.Attribute.Private;
    Trailers: Schema.Attribute.Component<'trailer.trailer', true>;
    Type: Schema.Attribute.Enumeration<['Serie', 'Movie', 'Special']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiNewsItemNewsItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    categories: Schema.Attribute.Component<'news-item.category', true>;
    content: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_published: Schema.Attribute.DateTime;
    guid: Schema.Attribute.String & Schema.Attribute.Required;
    imageUrl: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::page.page'> &
      Schema.Attribute.Private;
    parallaxConfig: Schema.Attribute.Component<
      'page-builder.parallax-config',
      false
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface PluginStrapiPluginFcmFcmNotification
  ...
  attributes: {
    ...
    isReleaseNotification: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    > &
      Schema.Attribute.Private;
    mcu_project: Schema.Attribute.Relation<
      'manyToOne',
      'api::mcu-project.mcu-project'
    >;
    ...
    targetType: Schema.Attribute.Enumeration<['topics']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'topics'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginStrapiPluginFcmFcmPluginConfiguration
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deviceLabelFieldName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'username'>;
    devicesTokensCollectionName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'up_users'>;
    deviceTokenFieldName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'device_token'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    serviceAccount: Schema.Attribute.JSON & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface PluginStrapiPluginFcmFcmTopic
  extends Struct.CollectionTypeSchema {
